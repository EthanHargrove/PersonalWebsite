...
import { Typography, Switch, Stack, FormGroup, FormControlLabel } from '@mui/material';
...
function TicTacToeGame() {
    ...
    const [qTable, setQTable] = useState<{[key: string]: number}>(qTable5000000RandSched);
        ...
        <div className='content'>
                ...
                <group>
                    ...
                    {board.map((row, rowIndex: number) => (
                        ...
                        row.map((piece, colIndex: number) => (
                            ...
                            : showVals ? (<ThreeText x={0.007*colXVals[colIndex]} y={0.007*rowYVals[rowIndex]} z={0.175} value={getQValue(rowIndex, colIndex)} gridArmLength={gridArmLength} depth={pieceDepth} row={rowIndex} col={colIndex} board={board} setBoard={setBoard} currentPlayer={currentPlayer} setCurrentPlayer={setCurrentPlayer}/>)
            ...
            <div className='q-table-slider'>
                ...
                <Stack direction="row" spacing={1} alignItems={"center"}>
                    <Typography style={fontStyle}>Random start</Typography>
                    <Switch 
                        defaultChecked
                    ...
                    <Switch 
                        ...
                        sx={customSwitchStyle}
                    />
                    <Typography style={fontStyle}>ε-scheduling</Typography>
                </Stack>
            </div>
        </div>
    )
